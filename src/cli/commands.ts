...
export const buildCommands = (
  ...
  commands.push(
    buildCommand(['load'], emptySchema, async (): Promise<void> => {
      await actions.load()
    })
  )
  commands.push(
  ...
  commands.push(
    buildCommand(['list', 'ls'], emptySchema, async (): Promise<void> => {
  ...
  commands.push(
    buildCommand(['stats'], emptySchema, async (): Promise<void> => {
      actions.printStats(safeCharacter().getName())
    })
  )
  commands.push(
    buildCommand(['tasks'], emptySchema, async (): Promise<void> => {
  ...
  commands.push(
    buildCommand(
      ...
      async (): Promise<void> => {
        localState
          .getCharacters()
          .forEach((c) => actions.printTaskStatus(c.getName()))
      }
    )
  )
  ...
  commands.push(
    buildCommand(
      ['move'],
      moveSchema,
      async (args: z.infer<typeof moveSchema>): Promise<void> => {
        await actions.moveCharacter(safeCharacter().getName(), args[0], args[1])
      }
    )
  )
  commands.push(
    buildCommand(['fight'], emptySchema, async (): Promise<void> => {
      await actions.fight(safeCharacter().getName())
    })
  )
  commands.push(
    buildCommand(['rest'], emptySchema, async (): Promise<void> => {
      await actions.rest(safeCharacter().getName())
    })
  )
  commands.push(
    buildCommand(['gather'], emptySchema, async (): Promise<void> => {
  ...
  commands.push(
    buildCommand(
      ['equip'],
      equipSchema,
      async (args: z.infer<typeof equipSchema>): Promise<void> => {
  ...
  commands.push(
    buildCommand(
      ['equip-num'],
      equipNumSchema,
      async (args: z.infer<typeof equipNumSchema>): Promise<void> => {
        await actions.equip(
  ...
  commands.push(
    buildCommand(
      ['unequip'],
      unequipSchema,
      async (args: z.infer<typeof unequipSchema>): Promise<void> => {
  ...
  commands.push(
    buildCommand(
      ['unequip-num'],
      unequipNumSchema,
      async (args: z.infer<typeof unequipNumSchema>): Promise<void> => {
        await actions.unequip(safeCharacter().getName(), args[0], args[1])
      }
    )
  )
  commands.push(
    buildCommand(['task-accept'], emptySchema, async (): Promise<void> => {
      await actions.acceptTask(safeCharacter().getName())
    })
  )
  commands.push(
    buildCommand(['task-complete'], emptySchema, async (): Promise<void> => {
  ...
  commands.push(
    buildCommand(
      ['deposit-gold'],
      bankGoldSchema,
      async (args: z.infer<typeof bankGoldSchema>): Promise<void> => {
  ...
  commands.push(
    buildCommand(
      ['run'],
      runBehaviorSchema,
      async (args: z.infer<typeof runBehaviorSchema>): Promise<void> => {
        behaviorRunner.runBehavior(safeCharacter(), args[0])
      }
    )
  )
  commands.push(
    buildCommand(['stop'], emptySchema, async (): Promise<void> => {
